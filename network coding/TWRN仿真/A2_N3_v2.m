...
% 接收状态
ack_H0_A1 = 0;
ack_A1_H0 = 0; ack_A1_B2 = 0;
ack_B2_A1 = 0; ack_B2_C3 = 0;
ack_C3_B2 = 0; ack_C3_T4 = 0;
ack_T4_C3 = 0;
    ...
    switch type
        case 0
            ...
            if ~isequal(PB_B2(1, :), empty) % 如果PB非空 发包
                ...
                if (flag_B2 == 0 || flag_B2 == 1) && (ack_A1_B2 == 1)
                    ack_B2_A1 = 1;
                    flag_B2 = 4;
                elseif (flag_B2 == 0 || flag_B2 == 2) && (ack_C3_B2 == 1)
                   ack_B2_C3 = 1;
                   flag_B2 = 4;
                end
        ...
        case 1
            ...
            if ~isequal(PB_C3(1, :), empty) % 如果PB非空 发包
                ...
                if (flag_C3 == 0 || flag_C3 == 1) && (ack_B2_C3 == 1)
                    ack_C3_B2 = 1;
                    flag_C3 = 4;
                elseif (flag_C3 == 0 || flag_C3 == 2) && (ack_T4_C3 == 1)
                    ack_C3_T4 = 1;
                    flag_C3 = 4;
                end
                if flag_C3 == 1
                ...
                % (5.2) 如果非空就递交上层判断
                % 在 n + 1时刻以后T节点才会收到包
                if ~isequal(T_receive, empty) && (ack_C3_T4 == 0) 
        ...
        case 2
            ...
            if ~isequal(PB_A1(1, :), empty)
                ...
                if (flag_A1 == 0 || flag_A1 == 1) && (ack_H0_A1 == 1)
                    ack_A1_H0 = 1;
                    flag_A1 = 4;
                elseif (flag_A1 == 0 || flag_A1 == 2) && (ack_B2_A1 == 1)
                    ack_A1_B2 = 1;
                    flag_A1 = 4;
                end
                ...
                if ~isequal(H_receive, empty) && (ack_A1_H0 == 0)
