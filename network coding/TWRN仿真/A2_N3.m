...
H_sent = PB_H0;
T_sent = PB_T4;
% 节点发包状态 0正常 1右传失败 2左传失败 3全失败 4暂缓
flag_H0 = 0;
flag_A1 = 0;
flag_B2 = 0;
flag_C3 = 0;
flag_T4 = 0;
% 节点往哪个方向发了包， 0是两边， 1左， 2右
state_H0 = 0;
state_A1 = 0;
state_B2 = 0;
state_C3 = 0;
...
for time = 1:slot
    ...
    switch type
        case 1
            ...
            if (flag_H0 == 0) && (flag_A1 == 2 || flag_A1 == 3 || flag_A1 == 4)
                flag_H0 = 4;
            end
            % 右侧重传或者正常发都一样
            if flag_H0 == 0 || flag_H0 == 1
                [flag_H0, cache_A1] = TransRight(SNR, cache_H0);
                state_H0 = 2;
            end
            % 中继A1收包
            if state_H0 == 2 && flag_H0 == 0 % 只要往A1侧发包成功
            ...
            if ~isequal(PB_C3(1, :), empty) % 如果PB非空 发包
                ...
                if (flag_C3 == 0 || flag_C3 == 1) && (flag_B2 == 1 || flag_B2 == 3 || flag_B2 == 4)
                    flag_C3 = 4;
                elseif (flag_C3 == 0 || flag_C3 == 2) && (flag_T4 ~= 0)
                    flag_C3 = 4;
                end
                if flag_C3 == 1
                    % 右侧重传, 左成功
                ...
                elseif flag_C3 == 2
                    ...
                    state_C3 = 1;
                elseif flag_C3 == 0 || flag_C3 == 3
                    % 传输过程是双向并发的
                    [flag_C3, cache_B2, cache_T4] = TransBi(SNR, PB_C3(1, :));
                    state_C3 = 0;
                end
                % 中继B2收包
                if (state_C3 == 0 || state_C3 == 1) && (flag_C3 == 0 || flag_C3 == 1)% 只要往B2侧发包成功
                ...
                % 端节点T4收包
                if (state_C3 == 0 || state_C3 == 2) && (flag_C3 == 0 || flag_C3 == 2) % 只要往C侧发包成功
                ...
                if (state_C3 == 0 || state_C3 == 2) && (flag_C3 == 0 || flag_C3 == 2)
                    % (5.3)弹出PB第一个包
                    PB_T4(1, :) = []; % 弹出PB第一个
        ...
        case 2
            ...
            if ~isequal(PB_A1(1, :), empty)
                ...
                if (flag_A1 == 0 || flag_A1 == 1) && (flag_H0 ~= 0)
                    flag_A1 = 4;
                elseif (flag_A1 == 0 || flag_A1 == 2) && (flag_B2 == 2 || flag_B2 == 3 || flag_B2 == 4)
                    flag_A1 = 4;
                end
                ...
                elseif flag_A1 == 2
                    ...
                    state_A1 = 1;
                elseif flag_A1 == 0 || flag_A1 == 3
                    % 传输过程是双向并发的
                    [flag_A1, cache_H0, cache_B2] = TransBi(SNR, PB_A1(1, :));
                    state_A1 = 0;
                end
                % 中继H0收包
                if (state_A1 == 0 || state_A1 == 1) && (flag_A1 == 0 || flag_A1 == 1) % 只要往H0侧发包成功
                    H_receive = XOR(cache_H0, PB_H0(1, :));
                end % 传输失败的情况，会直接跳过这一时隙，直到下一个发送时隙
                % 中继B2收包
                if (state_A1 == 0 || state_A1 == 2) && (flag_A1 == 0 || flag_A1 == 2) % 只要往B2侧发包成功
                ...
                if (state_A1 == 0 || state_A1 == 1) && (flag_A1 == 0 || flag_A1 == 1)
                    % (5.3)弹出PB第一个包
                    PB_H0(1, :) = [];
            ...
            if flag_T4 == 0 && (flag_C3 == 1 || flag_C3 == 3 || flag_C3 == 4)
                flag_T4 = 4;
            end
            
            % 右侧重传或者正常发都一样
            if flag_T4 == 0 || flag_T4 == 2
                [flag_T4, cache_C3] = TransLeft(SNR, cache_T4);
                state_T4 = 1;
            end
            % 中继C3收包
            if state_T4 == 1 && flag_T4 == 0 % 只要往C3侧发包成功
        ...
        case 0
            ...
            if ~isequal(PB_B2(1, :), empty) % 如果PB非空 发包
                ...
                if (flag_B2 == 0 || flag_B2 == 1) && (flag_A1 == 1 || flag_A1 == 3 || flag_A1 == 4)
                    flag_B2 = 4;
                elseif (flag_B2 == 0 || flag_B2 == 2) && (flag_C3 == 2 || flag_C3 == 3 || flag_C3 == 4)
                    flag_B2 = 4;
                end
                ...
                % 中继A1收包
                if (state_B2 == 0 || state_B2 == 1) && (flag_B2 == 0 || flag_B2 == 1) % 只要往A侧发包成功
                ...
                % 中继C3收包
                if (state_B2 == 0 || state_B2 == 2) && (flag_B2 == 0 || flag_B2 == 2) % 只要往C侧发包成功
